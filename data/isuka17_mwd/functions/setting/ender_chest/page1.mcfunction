...
execute as @s[scores={page=1}] unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page0
...
execute as @s[scores={page=1}] unless entity @s[nbt={EnderItems:[{Slot:10b,id:"minecraft:iron_horse_armor",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page2
...
execute as @s[scores={page=1}] unless entity @s[nbt={EnderItems:[{Slot:11b,id:"minecraft:skeleton_skull",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page3
...
execute as @s[scores={page=1}] unless entity @s[nbt={EnderItems:[{Slot:12b,id:"minecraft:quartz",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page4
...
execute as @s[scores={page=1}] unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:emerald",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page5