...
execute as @s[scores={mwd_settings_page=3}] at @s unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",Count:1b,tag:{change_page:1}}]}] run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
execute as @s[scores={mwd_settings_page=3}] at @s unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",Count:1b,tag:{change_page:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page1

execute as @s[scores={mwd_settings_page=3}] at @s if score deadbody mwd_settings matches 0 unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:redstone_block",Count:1b,tag:{change_page:1}}]}] run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
execute as @s[scores={mwd_settings_page=3}] at @s if score deadbody mwd_settings matches 0 unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:redstone_block",Count:1b,tag:{change_page:1}}]}] run function isuka17_mwd:setting/modify/deadbody

execute as @s[scores={mwd_settings_page=3}] at @s if score deadbody mwd_settings matches 1.. unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:emerald_block",Count:1b,tag:{change_page:1}}]}] run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
execute as @s[scores={mwd_settings_page=3}] at @s if score deadbody mwd_settings matches 1.. unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:emerald_block",Count:1b,tag:{change_page:1}}]}] run function isuka17_mwd:setting/modify/deadbody