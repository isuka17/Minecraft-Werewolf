...
execute as @s[scores={page=2}] at @s unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page1
...
execute as @s[scores={page=2}] at @s unless entity @s[nbt={EnderItems:[{Slot:12b,id:"minecraft:gold_ingot",Count:1b,tag:{pagechange:1}}]}] run loot replace entity @s enderchest.14 loot isuka17_mwd:invincible_time/minus_10
execute as @s[scores={page=2}] at @s unless entity @s[nbt={EnderItems:[{Slot:12b,id:"minecraft:gold_ingot",Count:1b,tag:{pagechange:1}}]}] run loot replace entity @s enderchest.12 loot isuka17_mwd:invincible_time/plus_10
...
execute as @s[scores={page=2}] at @s if score invincible_time mwd_settings matches 0 unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:redstone_block",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/modify/invincible_time
...
execute as @s[scores={page=2}] at @s if score invincible_time mwd_settings matches 1.. unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:emerald_block",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/modify/invincible_time
...
execute as @s[scores={page=2}] at @s unless entity @s[nbt={EnderItems:[{Slot:14b,id:"minecraft:iron_ingot",Count:1b,tag:{pagechange:1}}]}] run loot replace entity @s enderchest.12 loot isuka17_mwd:invincible_time/plus_10
execute as @s[scores={page=2}] at @s unless entity @s[nbt={EnderItems:[{Slot:14b,id:"minecraft:iron_ingot",Count:1b,tag:{pagechange:1}}]}] run loot replace entity @s enderchest.14 loot isuka17_mwd:invincible_time/minus_10