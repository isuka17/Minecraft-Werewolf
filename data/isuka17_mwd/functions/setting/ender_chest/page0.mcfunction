item replace entity @s enderchest.0 with black_stained_glass_pane{display:{Name:'{"text":""}'},pagechange:1}
...
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:10b,id:"minecraft:knowledge_book",Count:1b,tag:{pagechange:1}}]}] at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:10b,id:"minecraft:knowledge_book",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page1
...
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:11b,id:"minecraft:golden_horse_armor",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page6
...
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:12b,id:"minecraft:potion",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page7
...
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:bow",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page4

execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:14b,id:"minecraft:clock",Count:1b,tag:{pagechange:1}}]}] at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:14b,id:"minecraft:clock",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page5

execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:26b,id:"minecraft:ender_eye",Count:1b,tag:{pagechange:1}}]}] at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:26b,id:"minecraft:ender_eye",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/preview