...
execute as @s[scores={page=4}] at @s unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/ender_chest/change_page/page1
...
execute as @s[scores={page=4}] at @s if score quartz mwd_settings matches 0 unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:redstone_block",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/modify/quartz
...
execute as @s[scores={page=4}] at @s if score quartz mwd_settings matches 1.. unless entity @s[nbt={EnderItems:[{Slot:13b,id:"minecraft:emerald_block",Count:1b,tag:{pagechange:1}}]}] run function isuka17_mwd:setting/modify/quartz