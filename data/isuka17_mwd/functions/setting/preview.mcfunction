...
item replace entity @s enderchest.26 with ender_eye{display:{Name:'{"text":"有効な設定を表示","color":"gold","italic":false}',Lore:['[{"text":"[","color":"white","italic":false},{"keybind":"key.attack","color":"light_purple","italic":false},{"text":"] または ","color":"white","italic":false}]','[{"text":"[","color":"white","italic":false},{"keybind":"key.use","color":"light_purple","italic":false},{"text":"] で"},{"text":"有効な設定","color":"gold"},{"text":"を表示"}]']},change_page:1}