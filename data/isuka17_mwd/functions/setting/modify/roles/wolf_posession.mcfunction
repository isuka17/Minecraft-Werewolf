...
execute if score wolf_possession mwd_settings matches 0 run item replace entity @s enderchest.24 with green_stained_glass{display:{Name:'{"text":"狼憑きの出現確率 現在:0%","color":"dark_green","italic":false}'},change_page:1,wolf_possession:1}
execute if score wolf_possession mwd_settings matches 1 run item replace entity @s enderchest.24 with green_stained_glass{display:{Name:'{"text":"狼憑きの出現確率 現在:30%","color":"dark_green","italic":false}'},change_page:1,wolf_possession:1}
execute if score wolf_possession mwd_settings matches 2 run item replace entity @s enderchest.24 with green_stained_glass{display:{Name:'{"text":"狼憑きの出現確率 現在:50%","color":"dark_green","italic":false}'},change_page:1,wolf_possession:1}
execute if score wolf_possession mwd_settings matches 3 run item replace entity @s enderchest.24 with green_stained_glass{display:{Name:'{"text":"狼憑きの出現確率 現在:100%","color":"dark_green","italic":false}'},change_page:1,wolf_possession:1}
