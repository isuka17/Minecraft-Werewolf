#人狼の数変更
scoreboard players add wolf mwd_settings 1
execute if score wolf mwd_settings matches 4 run scoreboard players set wolf mwd_settings 0

execute if score wolf mwd_settings matches 0 run tellraw @s [{"text":"人狼の数を","color":"red"},{"text":"0人","bold":true},{"text":"に設定しました。","bold":false}]
execute if score wolf mwd_settings matches 1 run tellraw @s [{"text":"人狼の数を","color":"red"},{"text":"1人","bold":true},{"text":"に設定しました。","bold":false}]
...
execute if score wolf mwd_settings matches 1 run scoreboard players set 人狼の数:1人 setting_preview -1
execute if score wolf mwd_settings matches 2 run scoreboard players set 人狼の数:2人 setting_preview -1
execute if score wolf mwd_settings matches 3 run scoreboard players set 人狼の数:3人 setting_preview -1
