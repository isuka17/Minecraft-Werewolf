...
execute if score faker mwd_settings matches 0 run item replace entity @s enderchest.2 with red_stained_glass{display:{Name:'{"text":"フェイカーの人数設定 現在:0人","color":"red","italic":false}'},change_page:1,wolf:3}
execute if score faker mwd_settings matches 1 run item replace entity @s enderchest.2 with red_stained_glass{display:{Name:'{"text":"フェイカーの人数設定 現在:1人","color":"red","italic":false}'},change_page:1,wolf:3}
