...
schedule function isuka17_mwd:bossbar/camouflage/timer 1s
...
execute if score camouflage mwd_settings matches 0 run schedule clear isuka17_mwd:bossbar/camouflage/timer