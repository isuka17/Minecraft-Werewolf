...
# 盗んだ役職を通知
tellraw @a[scores={thief=1..},tag=normal_wolf] [{"selector":"@a[tag=stolen]"},{"text":"から人狼を盗みました"}]
tellraw @a[scores={thief=1..},tag=madman] [{"selector":"@a[tag=stolen]"},{"text":"から狂人を盗みました"}]
tellraw @a[scores={thief=1..},tag=fanatic] [{"selector":"@a[tag=stolen]"},{"text":"から狂信者を盗みました"}]
tellraw @a[scores={thief=1..},tag=fox] [{"selector":"@a[tag=stolen]"},{"text":"から妖狐を盗みました"}]
tellraw @a[scores={thief=1..},tag=immoral] [{"selector":"@a[tag=stolen]"},{"text":"から背徳者を盗みました"}]
tellraw @a[scores={thief=1..},tag=alice] [{"selector":"@a[tag=stolen]"},{"text":"からアリスを盗みました"}]
tellraw @a[scores={thief=1..},tag=seer] [{"selector":"@a[tag=stolen]"},{"text":"から予言者を盗みました"}]
tellraw @a[scores={thief=1..},tag=medium] [{"selector":"@a[tag=stolen]"},{"text":"から霊媒師を盗みました"}]
tellraw @a[scores={thief=1..},tag=sharer] [{"selector":"@a[tag=stolen]"},{"text":"から共有者を盗みました"}]
tellraw @a[scores={thief=1..},tag=knight] [{"selector":"@a[tag=stolen]"},{"text":"から騎士を盗みました"}]
tellraw @a[scores={thief=1..},tag=detective] [{"selector":"@a[tag=stolen]"},{"text":"から探偵を盗みました"}]
tellraw @a[scores={thief=1..},tag=villager] [{"selector":"@a[tag=stolen]"},{"text":"から村人を盗みました"}]

# 仲間/相方を通知
execute as @a[scores={thief=1..}] at @s run function isuka17_mwd:start/message
...
scoreboard players add @a[scores={thief=1..},tag=seer] mwd_ability 1
scoreboard players add @a[scores={thief=1..},tag=medium] mwd_ability 1
scoreboard players add @a[scores={thief=1..},tag=knight] mwd_ability 1
scoreboard players add @a[scores={thief=1..},tag=detective] mwd_ability 1
scoreboard players add @a[scores={thief=1..},tag=witch] mwd_ability 1
