...
execute if entity @a[tag=wolf,tag=penetrate,team=!ghost] run tellraw @a[scores={penetrate=1..},tag=seer] [{"selector":"@a[tag=penetrate]","color":"red"},{"text":"は人狼です。","color":"red"}]
execute if entity @a[tag=wolf_possession,tag=!wolf,tag=penetrate,team=!ghost] run tellraw @a[scores={penetrate=1..},tag=seer] [{"selector":"@a[tag=penetrate]","color":"red"},{"text":"は人狼です。","color":"red"}]
execute if entity @a[tag=!wolf,tag=!wolf_possession,tag=penetrate,team=!ghost] run tellraw @a[scores={penetrate=1..},tag=seer] [{"selector":"@a[tag=penetrate]","color":"#0080ff"},{"text":"は人狼ではありません。","color":"#0080ff"}]
execute if entity @a[tag=penetrate,team=ghost] run tellraw @a[scores={penetrate=1..},tag=seer] [{"selector":"@a[tag=penetrate]","color":"gray"},{"text":"は既に死亡しています。","color":"gray"}]
