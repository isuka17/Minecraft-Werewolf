...
execute at @s[nbt={SelectedItem:{tag:{faker_use:1}}}] as @r run loot replace entity @e[type=armor_stand,sort=nearest,limit=1,tag=deadbody,nbt={Passengers:[{id:"minecraft:item"}],ArmorItems:[{},{},{},{}]}] armor.head loot werewolf:playerhead
