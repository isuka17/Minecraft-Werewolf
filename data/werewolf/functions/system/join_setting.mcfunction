...
tellraw @a[scores={join=2..},team=!not_join_request] [{"text":"[Werewolf] ","color":"red"},{"text":"参加しない","color":"dark_aqua"},{"text":"に設定しました。","color":"white"}]
...
tellraw @a[scores={join=2..},team=not_join_request] [{"text":"[Werewolf] ","color":"red"},{"text":"既に","color":"white"},{"text":"参加しない","color":"dark_aqua"},{"text":"に設定しています。","color":"white"}]
title @a[team=join_request] actionbar [{"text":"参加を希望","color":"gold"},{"text":"に設定中","color":"white"}]
title @a[team=not_join_request] actionbar [{"text":"参加しない","color":"dark_aqua"},{"text":"に設定中","color":"white"}]
...
team join not_join_request @a[scores={join=2..}]
