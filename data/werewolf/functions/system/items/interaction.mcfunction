...
execute as @s[nbt={SelectedItem:{id:"minecraft:nether_star",tag:{camouflager_use:1}}},scores={ability_usecount=1..}] at @s run function werewolf:system/ability/camouflager/camouflage
