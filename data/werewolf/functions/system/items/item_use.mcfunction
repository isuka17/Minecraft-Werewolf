...
execute if entity @a[nbt={SelectedItem:{id:"minecraft:player_head",tag:{camouflage:1}}}] unless entity @e[type=interaction,tag=camouflage_use] run summon interaction ~ ~ ~ {width:1.5f,height:1.5f,Tags:["camouflage_use"]}
