...
execute if score camouflage setting matches 0 run clear @a[tag=join] player_head{camo:1}
...
execute if score camouflage setting matches 0 run schedule clear werewolf:system/bossbar/camouflage/timer