#無敵時間
scoreboard players add invincible_time mwd_settings 1
execute if score invincible_time mwd_settings matches 2.. run scoreboard players set invincible_time mwd_settings 0
...
execute if score invincible_time mwd_settings matches 1 run scoreboard players set 無敵時間 setting_preview -25
