#mediumの数変更
scoreboard players add medium mwd_settings 1
execute if score medium mwd_settings matches 2 run scoreboard players set medium mwd_settings 0
...
execute if score medium mwd_settings matches 1 run scoreboard players set 霊媒師の数:1人 setting_preview -11
