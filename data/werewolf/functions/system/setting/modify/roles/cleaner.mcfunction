...
execute if score cleaner mwd_settings matches 0 run item replace entity @s enderchest.4 with red_stained_glass{display:{Name:'{"text":"クリーナーの人数設定 現在:0人","color":"red","italic":false}'},pagechange:1,wolf:5}
execute if score cleaner mwd_settings matches 1 run item replace entity @s enderchest.4 with red_stained_glass{display:{Name:'{"text":"クリーナーの人数設定 現在:1人","color":"red","italic":false}'},pagechange:1,wolf:5}
