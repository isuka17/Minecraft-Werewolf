...
data modify storage item 9 set from entity @s EnderItems[{Slot:10b}]
data modify storage item 10 set from entity @s EnderItems[{Slot:11b}]
data modify storage item 11 set from entity @s EnderItems[{Slot:12b}]
data modify storage item 12 set from entity @s EnderItems[{Slot:13b}]
data modify storage item 13 set from entity @s EnderItems[{Slot:14b}]
data modify storage item 14 set from entity @s EnderItems[{Slot:15b}]
data modify storage item 15 set from entity @s EnderItems[{Slot:16b}]
data modify storage item 16 set from entity @s EnderItems[{Slot:17b}]
