...
give @s iron_helmet{display:{Name:'{"text":"地雷","color":"dark_green","italic":false}',Lore:['{"text":"踏んだプレイヤーを即死させるアイテム。","color":"white","italic":false}','{"text":"地雷が設置された場所は","color":"white","italic":false}','{"text":"パーティクルで強調表示される。","color":"white","italic":false}']},mine:1}
...
give @s iron_horse_armor{display:{Name:'{"text":"無敵の鎧","color":"#c0c0c0","italic":false}',Lore:['{"text":"5秒間だけ無敵になる。","italic":false,"color":"white"}']}}
...
give @s trident{display:{Name:'{"text":"爆殺のトライデント","color":"red","italic":false}',Lore:['{"text":"周囲のプレイヤーを即死させる。","color":"white","italic":false}']}}