...
execute as @s[scores={page=5}] at @s unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",Count:1b,tag:{pagechange:1}}]}] run function werewolf:system/setting/ender_chest/change/page1
...
execute as @s[scores={page=5}] at @s if score random_start mwd_settings matches 0 unless entity @s[nbt={EnderItems:[{Slot:10b,id:"minecraft:redstone_block",Count:1b,tag:{pagechange:1}}]}] run function werewolf:system/setting/modify/random_start
...
execute as @s[scores={page=5}] at @s if score random_start mwd_settings matches 1.. unless entity @s[nbt={EnderItems:[{Slot:10b,id:"minecraft:emerald_block",Count:1b,tag:{pagechange:1}}]}] run function werewolf:system/setting/modify/random_start
