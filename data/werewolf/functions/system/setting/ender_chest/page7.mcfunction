...
execute as @s[scores={page=7}] unless entity @s[nbt={EnderItems:[{Slot:0b,id:"minecraft:barrier",tag:{pagechange:1}}]}] run function werewolf:system/setting/ender_chest/change/page0
...
execute as @s[scores={page=7}] unless entity @s[nbt={EnderItems:[{Slot:9b,id:"minecraft:heart_of_the_sea",tag:{pagechange:1}}]}] run function werewolf:system/setting/ender_chest/item/get
...
execute as @s[scores={page=7}] unless entity @s[nbt={EnderItems:[{Slot:18b,id:"minecraft:structure_void",tag:{pagechange:1}}]}] run function werewolf:system/setting/ender_chest/item/save