...
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:14b,id:"minecraft:clock",Count:1b,tag:{pagechange:1}}]}] run function werewolf:system/setting/ender_chest/change/page5
...
execute as @s[scores={page=0}] unless entity @s[nbt={EnderItems:[{Slot:26b,id:"minecraft:ender_eye",Count:1b,tag:{pagechange:1}}]}] run function werewolf:system/setting/preview